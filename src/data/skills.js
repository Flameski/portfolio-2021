export const skills = [
  ...
  },
  {
    ...
    name: "JavaScript",
    description:
      "Езикът, който задвижва уеб-а. Използвал съм го за изграждане на фронтенд елементи и логика.",
    descriptionEn:
      "The language that powers the web. I've used it to create front-end elements and logic.",
